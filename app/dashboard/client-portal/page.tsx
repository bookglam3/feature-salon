                    ...
                    return (
                      <tr key={i} style={{ transition: "background 0.1s", cursor: "pointer" }}
                        ...
                        <td style={{ padding: "12px 16px", borderBottom: "1px solid #ECE9F1" }} onClick={e => e.stopPropagation()}>
                          <button onClick={() => sendPortalLink(c)} style={{ padding: "5px 12px", background: "rgba(124,58,237,0.10)", color: "#7C3AED", border: "none", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: "pointer" }}>Portal</button>
                        </td>
                      </tr>
                    );
                  })}
